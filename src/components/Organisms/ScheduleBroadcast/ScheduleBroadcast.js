  ...
  return (
    ...
    >
      <HeadingInfo
        ...
        popupText={"Disabling this will only show chapters on players and overlay. This setting cannot be changed later for this broadcast."}
      />
...
const ScheduleBroadcast = () => {
  ...
  return (
    <div className={container} style={{ padding: "40px 0" }}>
      <OptionSelector />
      <div style={{ marginTop: "20px" }}>
        <TextInput label="Title" placeholder="enter broadcast title" padding="10px" />
      </div>
      <div style={{ marginTop: "20px" }}>
        <RichTextEditor label="Description" value={description} onChange={setDescription} placeholder="enter broadcast description" />
      </div>
